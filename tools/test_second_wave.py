...
def run_tests():
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        r = subprocess.run([sys.executable, str(saipen_py), "--project-root", str(project), "userperson", "add", "my key is sk-1234567890123456789012345678901234567890"], cwd=str(project), capture_output=True, text=True)
