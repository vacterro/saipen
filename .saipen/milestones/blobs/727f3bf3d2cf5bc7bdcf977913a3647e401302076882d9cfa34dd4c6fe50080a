...
| `saipen translate` | Изолирано изграждане на превод на 32 езика |
| `saipen markhunt` | Дълбок, неограничен одит -- само записва находки |
| `saipen prepare` | Пакетира работата за предаване на следващия агент |
