...
## TODO
- [ ] SAIT-010 [P2] Palette name fix: "Vintage Golden" corruption in 3 SPECs (da/de/hi/sv/zh) + 14 READMEs (ar da es et fi fr hu it ko no pt ro sk sv tr). ded/et already fixed in E-1821 Core scope. SPEC_DA stale directory tree refresh. | verify: grep "Vintage Golden" returns correct count across all files; SPEC_DA tree fresh

## DONE
- [x] SAIT-009 [P1] 29-locale README restructure to ET template outline — all 29 kitchen READMEs restructured with How it works / Commands table / Two layers / Quick Start / Documentation table / Guide list / Screenshots structure. Existing translations preserved. Commands table + Documentation table in English (structural, identical across locales). | verify: all 29 locale READMEs carry new outline; structural sections present across all; validate.py shortcut-callout check PASS
