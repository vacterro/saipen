...
**v7.106.0** | [Spec](SPEC.md) | [Guide](GUIDE.md) | [RFC](saipen/RFC.md) | [Style](saipen/STYLE.md) | [UI](saipen/UI.md) | [Conformance](saipen/CONFORMANCE.md) | plain markdown | zero deps | MIT
...
**1. Install once per machine** -- teaches Claude Code, Gemini, OpenCode, Aider, Antigravity, Codex dan pembaca ~/.agents/skills generik apa pun (FreeBuff, dll.):
```bash
