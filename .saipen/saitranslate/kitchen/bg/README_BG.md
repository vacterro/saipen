...
**Бързи клавиши:** `cc` продължава контекста на проекта до конвергенция (подновява текущата цел, ако е зададена), `sss` показва статус без допиране до кода, а `ss` запазва контролна точка и спира. [Виж пълната карта с 15 клавиша](saipen/RFC.md#110-command-surface). Кирилските близнаци също работят: `сс`, `ссс`, `аа`, `ее`, `еее`, `рр`.
...
**v7.223.12** | [Спецификация](SPEC.md) | [Ръководство](GUIDE.md) | [RFC](saipen/RFC.md) | [Стил](saipen/STYLE.md) | [UI](saipen/UI.md) | [Съответствие](saipen/CONFORMANCE.md) | чист markdown | нула зависимости | MIT
...
> Прочетете <clone>/saipen/INDEX.md + <clone>/saipen/STYLE.md и ги следвайте.
