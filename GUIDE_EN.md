...
| `saipen translate` | **The Interpreter.** Builds out a full translation bundle for the software (22 languages) in a sealed-off folder, never touching your actual source code while it works. | *Scenario:* You're shipping to a global audience and need every string translated without risking a stray edit to the real app. |
