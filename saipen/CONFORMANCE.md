...
| 41 | `saipen status` answers the question actually being asked -- alongside phase/ticket/queue it reports what is waiting on a human, what is claimed but unproven, the last recorded conformance result, and staleness; and it states facts without pronouncing the project healthy or ready (RFC § 1.10, v7.80.0) | `status-answers-the-real-question` -- behavioral, README-only |
