...
0. **Claim the ticket**: If you haven't already, move the top workable ticket from `## TODO` to `## DOING`, change its checkbox to `[/]`, and set your `owner:` and `claim_time:` fields on it (CORE.md §1.4).
...
7. Checkpoint: write `BOARD.md` then `STATE.md` in that order (CORE.md §1.5).
