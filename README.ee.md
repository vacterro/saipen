...
**Kiirklahvid:** `cc` jätkab aktiivset Goal Mode’i, `sss` näitab olekut koodi puudutamata ja `ss` salvestab kontrollpunkti ning peatub. [Vaata täielikku 14 kiirklahvi kaarti](saipen/RFC.md#110-command-surface). Kirillitsa kaksikud töötavad ka: `сс`, `ссс`, `аа`, `ее`, `еее`, `рр`.
...
**v7.176.0** | [Spetsifikatsioon](SPEC.md) | [Juhend](GUIDE.md) | [RFC](saipen/RFC.md) | [Stiil](saipen/STYLE.md) | [UI](saipen/UI.md) | [Vastavus](saipen/CONFORMANCE.md) | MIT
...
**Projekti olek on tugevam kui mudeli mälu.** Mälu elab projektis, mitte mudeli peas. `Projekt -> Mälu -> LLM` muutub `Projekt -> SAIPEN Olek -> LLM`.
...
| `/saipen plan` | Muuda palve või toores tööjärg piletiteks |
| `/saipen goal <text>` | Autonoomne lainerünnak uue eesmärgi vastu |
| `/saipen hunt` | Sunni defektide/paranduste otsing kohe |
| `/saipen ship` | Versioonitõstmine, muutuste logi, märgis, tõuge |
| `/saipen clean` | Repo puhastamine |
...
| `/saipen status` | Ainult lugemiseks aruanne |
